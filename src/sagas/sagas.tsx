...
const setUsername = function* setUsername(action: any) {
...
const setPassword = function* setPassword(action: any) {
...
const watchPostTweet = function* watchPostTweet() {
    ...
    yield takeEvery("POST_TWEET", function* (this: any, action: any, ) {
